...
/*yêu cầu 2 - tìm ra entry page và lượt truy cập*/ -- đúng
...
group by 1; /*đúng như đề cho*/
--------------------------------------------------------------------------------------------- 
/*yêu cầu 3 - Phân tích landingpage*/ -- đúng
...
drop table nonbrand_test_session_w_landing_page;
...
select 
sum(bounced_session.count_of_pageviews)
from bounced_session
group by bounced_session.landing_page;
